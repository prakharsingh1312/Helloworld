...
<br>
<div class="row">
	<div class="col-sm-1"></div><h1 class="display-4">View Submission</h1></div>
	<br>
	<div class="row">
		<div class="col-sm-1"></div><div class="col-sm-8 font-weight-bolder">Question</div><div class="col-sm-1 font-weight-bolder">Correct Answer</div><div class="col-sm-1 font-weight-bolder">Given Answer</div>
	</div><br>
	<?php 
	if($count1==0)
		echo'<div class="row">
