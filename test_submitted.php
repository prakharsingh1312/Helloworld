...
<div class="row">
	<div class="col-sm-1"></div><h1 class="display-4"><?php echo $result['name']; ?></h1></div>
	<div class="row"><div class="col-sm-1"></div><h1 class="text-muted">Your test was submitted successfully.</h1></div>
	<br>
	<?php unset($_SESSION['numq']);
	unset($_SESSION['cans']);
	unset($_SESSION['q']);
	unset($_SESSION['text']);
	unset($_SESSION['qid']);
